...
export const SectionContact = () => {
    ...
    return (<SectionWithTitle title={desc.titleItem.contact}>
        <div className="grid min-h-36 grid-cols-2 grid-rows-1">
            ...
            <div className="relative">
                ...
                <div className="relative p-10">
                    ...
                    <div className="relative flex gap-12 pt-10">
                        {desc.contactInfo.map((elt, key) => {
                            return <a className=" w-fit" key={key} href={elt.link}> <img src={`/img/${elt.icon}_${suffixe}.png`} alt={elt.icon} /> </a>
                        })}
                    </div>
                </div>
            </div>
